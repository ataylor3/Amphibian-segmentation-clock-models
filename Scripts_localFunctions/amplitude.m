...
%% S6A: A. mexicanum, Brownian Motion (normal diffusion) model
...
%% S6C: A. mexicanum, Brownian Motion (normal diffusion) model
...
%% S6E: A. mexicanum, Brownian Motion (normal diffusion) model
...
%% S6B: A. mexicanum, fractional Brownian Motion (obstructed diffusion) model
% mRNA half-life = export time
...
%% S6D: A. mexicanum, fractional Brownian Motion (obstructed diffusion) model
% mRNA half-life = 1/2 export time
...
%% S6F: A. mexicanum, fractional Brownian Motion (obstructed diffusion) model
% mRNA half-life = 1/4 export time
